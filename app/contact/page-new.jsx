...
const contactMethods = [
  ...
  },
  {
    ...
    value: '+91 8349859827',
    icon: Phone,
    action: 'tel:+91834985982',
    primary: false,
  },
  {
    title: 'Location',
    description: 'Based in Bhopa;, India',
...
const socialLinks = [
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/adarsh-bhardwaj-92072b316/',
    icon: Linkedin,
    description: 'Professional network',
  },
  {
    name: 'GitHub',
    url: 'https://github.com/ADARSHBHARDWAJ21',
    icon: Github,
            ...
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" asChild>
                  <a href="mailto:adarshbhardwaj1919@gmail.com">
                    Start a Project
