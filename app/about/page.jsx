...
const skills = [
  ...
  { category: 'Databases', items: ['Supabse',  'MongoDB', ] },
...
//     description: 'Contributing to the field of web privacy and data protection through academic research.',
//     icon: BookOpen,
//     year: '2024',
//   },
//   {
//     title: 'Open Source Contributions',
//     description: 'Actively contributing to open-source projects and building tools for the developer community.',
//     icon: Code,
//     year: '2023-2024',
//   },
//   {
//     title: 'Academic Excellence',
//     description: 'Maintaining high academic standards while pursuing research and development projects.',
//     icon: Award,
//     year: '2022-2024',
//   },
//   {
//     title: 'Technical Leadership',
//     description: 'Leading technical initiatives and mentoring fellow developers in best practices.',
//     icon: Users,
//     year: '2023-2024',
//   },
// ]
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  I&apos;m a Computer Science Engineer driven by a passion to create a safe digital world. 
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            When I’m not diving into the world of code and development, I love discovering new ideas, exploring the vibrant culture around me in Bhopal, and learning through real-world experiences. I enjoy contributing to exciting projects, helping others grow through collaboration, and staying curious about evolving technologies. I believe continuous learning and creativity are the keys to building impactful solutions — and I’m always excited for what comes next..
            </p>
