...
const techStack = ["Python", "JavaScript", "Mongodb", "Supabase", "java"];
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>Open to web development opportunities</span>
              </div>
            </Badge>
            <div className="space-y-6">
              ...
              >
                A passionate Full Stack Developer, I specialize in building modern web applications with React, Next.js, and JavaScript.{" "}
              </motion.p>
            </div>
